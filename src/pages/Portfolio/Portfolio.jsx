          ...
          {Data.data.map((item) => {
            return (
              <div key={item.id} className={`portfolio__wrapper__project `}>
                <div
                  className={`portfolio__wrapper__project__links  ${
                ...
                >
                  <a
                    ...
                    href={item?.link}
                    id={item.id}
                    className="portfolio__wrapper__project"
                  >
                    <h4>{item.title}</h4>
                  </a>
                </div>
                <div
                  ...
                  className="portfolio__wrapper__project__background "
                >
                  <OwlCarousel items={1} autoplay loop autoplayTimeout={4000}>
